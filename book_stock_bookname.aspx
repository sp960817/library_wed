<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="book_stock_bookname.aspx.cs" Inherits="book_stock_bookname" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
    您要更改库存的书籍名称是<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
